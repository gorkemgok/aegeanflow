...
public class NodeInfo {
    ...
    private final Class<? extends RunnableNode> nodeClass;
    ...
    public NodeInfo(Class<? extends RunnableNode> nodeClass, NodeDefinition definition, Map<String, Method> inputMethods, Map<String, Method> configMethods) {
